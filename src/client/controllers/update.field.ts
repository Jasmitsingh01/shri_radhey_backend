...
const updateField = RequestHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        updateClient.family.father.occupation_Details=father_occupation_detalis
        updateClient.family.mother.name = mother_name;
        updateClient.family.mother.occupation = mother_occupation;
        updateClient.family.mother.occupation_Details=mother_occupation_detalis
        updateClient.family.details = details;
